...
resumL<- lapply(fitxersEstat, function(x){
  estat<- read.csv(x)
  resum<- colSums(estat[, c("nObjectes", "nCasos", "nObjectesNomWikidata", "nCasosNomWikidata")])
})
...
knitr::kable(resum, caption="Numero de casos pendents d'afegir l'etiqueta ```name:ca``` per cada projecte. Per projectes sense revisió unificada, pot haver-hi casos duplicats en fitxers diferents.")
```
